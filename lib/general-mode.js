...
module.exports = function GeneralMode (displayId, sGrid, wChanger, TerminalWindow) {
  ...
  return Object.assign(state, {
    ...
    movePaneMain: (direction) => moveOrThrow(sGrid, () => sGrid.maxLoc({[direction]: true})), // TODO: fix sGrid's api
    movePaneSecondary: (direction) => moveOrThrow(sGrid, () => sGrid.changeCurWindow(directionToRelation(direction, state.resizeAmount))),
