...
module.exports = function GeneralMode (displayId, sGrid, wChanger, TerminalWindow) {
  ...
  return Object.assign(state, {
    addPaneMain: () => sGrid.createWindowCentered(displayId, TerminalWindow, Object.assign({}, state.winOpts, state.smallWindowSize), state.listeners),
    addPaneSecondary: () => sGrid.createWindowCentered(displayId, TerminalWindow, Object.assign({}, state.winOpts, state.largeWindowSize), state.listeners),
