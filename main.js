...
function tmuxMode (sGrid, wChanger) {
  ...
  globalShortcut.register('Super+Shift+L', () => sGrid.switchWindowContents('right'))
  globalShortcut.register('Super+Shift+H', () => sGrid.switchWindowContents('left'))
  globalShortcut.register('Super+Shift+J', () => sGrid.switchWindowContents('down'))
  globalShortcut.register('Super+Shift+K', () => sGrid.switchWindowContents('up'))
  globalShortcut.register('Super+Alt+L', () => sGrid.increaseAndFillCurWinSize('right', 30))
  globalShortcut.register('Super+Alt+H', () => sGrid.increaseAndFillCurWinSize('left', 30))
  globalShortcut.register('Super+Alt+J', () => sGrid.increaseAndFillCurWinSize('down', 30))
  globalShortcut.register('Super+Alt+K', () => sGrid.increaseAndFillCurWinSize('up', 30))
  globalShortcut.register('Super+Alt+Shift+L', () => sGrid.decreaseAndFillCurWinSize('right', 30))
  globalShortcut.register('Super+Alt+Shift+H', () => sGrid.decreaseAndFillCurWinSize('left', 30))
  globalShortcut.register('Super+Alt+Shift+J', () => sGrid.decreaseAndFillCurWinSize('down', 30))
  globalShortcut.register('Super+Alt+Shift+K', () => sGrid.decreaseAndFillCurWinSize('up', 30))
